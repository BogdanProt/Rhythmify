...
{
    /// <inheritdoc />
    public partial class initwin : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeedsId = table.Column<int>(type: "int", nullable: false),
                    PostsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedPost", x => new { x.FeedsId, x.PostsId });
                    table.ForeignKey(
                        name: "FK_FeedPost_Feeds_FeedsId",
                        column: x => x.FeedsId,
                        principalTable: "Feeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeedPost_Posts_PostsId",
                        column: x => x.PostsId,
